...
#headline
  ...
  :::
#title
基于 [Git]{.text-primary} 的 Nuxt :br 内容管理系统。
...
#description
Nuxt Content 是 Nuxt 的一个模块，提供了一种简单的方法来管理您的应用内容。它允许开发者以 Markdown、YAML 或 JSON 文件编写内容，然后在应用中查询并展示这些内容。
