...
::warning
如果你没有使用 `components/content/` 目录，在 Markdown 中使用的组件必须在你的 Nuxt 应用中标记为 `global`。访问 [Nuxt 3 文档](https://nuxt.zhcndoc.com/docs/guide/directory-structure/components) 了解更多。
::
